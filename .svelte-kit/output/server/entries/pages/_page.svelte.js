...
import { n as noop, j as fallback, k as head, l as bind_props, m as stringify, o as slot, q as copy_payload, t as assign_payload, f as pop, p as push, u as ensure_array_like } from "../../chunks/index.js";
...
function Cell($$payload, $$props) {
  ...
  $$payload.out += `<div${attr("class", `cell ${stringify(last ? "cell-last" : "")}  svelte-dt9dq0`)}><!---->`;
...
function Priority($$payload, $$props) {
  ...
  $$payload.out += `<span${attr("class", clsx(disabled ? "DISABILITATO" : prio2str(prio)) + " svelte-evcnxc")}>${escape_html(prio2str(prio))}</span>`;
...
function _page($$payload) {
  $$payload.out += `<main class="svelte-jpakl">`;
  Todo_list($$payload);
  $$payload.out += `<!----></main>`;
}
export {
